...
const SignUp = ({ open, setOpen }) => {
  ...
  const onSubmit = async (data) => {
    ...
    if (isRegistered) {
      URL = accountType === "seeker" ? `${baseURL}/auth/register` : `${baseURL}/companies/register`;
    }
    else {
      URL = accountType === "seeker" ? `${baseURL}/auth/login` : `${baseURL}/companies/login`;
    }
              ...
              <Dialog.Panel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all '>
                  ...
                  >
                    ...
                    {isRegistered && (
                      <div className='w-full flex gap-1 md:gap-2'>
                        ...
                        {accountType === "seeker" && isRegistered && (
                          <div className='w-1/2'>
                            <TextInput
                              name='lastName'
                              label='Last Name'
                    ...
                    <div className='w-full flex gap-1 md:gap-2'>
                      <div className={`${isRegistered ? "w-1/2" : "w-full"}`}>
                        <TextInput
                          name='password'
                          label='Password'
                    ...
                    <div className='mt-2'>
                      <CustomButton
                        ...
                        title={isRegistered ? "Create Account" : "Login Account"}
                      />
                    </div>
                  </form>
                  ...
                  <div className='mt-4'>
                    <p className='text-sm text-gray-700'>
                      ...
                      <span
                        className='text-sm hover:transition transition ease-in duration-150 text-blue-600 ml-2 hover:text-blue-700 hover:font-semibold cursor-pointer'
