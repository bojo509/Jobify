...
const Navbar = () => {
  ...
  return (
    <>
      <div className='relative bg-[#f7fdfd] z-50 width-full'>
              ...
              !user?.token ?
                (<Link to='/user-auth' className='flex items-center gap-2'>
                  <CustomButton title='Sign in'
                    containerStyles="text-blue-600 py-1.5 px-5 focus:outline-none hover:bg-blue-700 hover:text-white rounded-full text-base border border-blue-600 transition ease-in-out delay-100" />
                </Link>
                ) : <MenuList user={user} />
            }
          </div>
        ...
        >
          <Link to='/' onClick={handleNavbarClose}>
            Find Job
          </Link>
          <Link to='/companies' onClick={handleNavbarClose}>
            Companies
          </Link>
          <Link
          ...
          <div className='w-full py-10'>
            {!user?.token ? (
              ...
              <div>
                <MenuList user={user} onClick={handleNavbarClose} />
              </div>
            )}
          </div>
        </div>
